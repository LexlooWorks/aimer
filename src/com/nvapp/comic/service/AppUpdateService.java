package com.nvapp.comic.service;
...
public class AppUpdateService extends Service {
	public static final String saveFileName = Environment.getExternalStorageDirectory().getPath() + "compic.apk";
	// 标题
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		updateNotification.setLatestEventInfo(this, "指读", "0%", updatePendingIntent);
		// 发出通知
	...
	private Handler updateHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_COMPLETE:
				...
				updateNotification.setLatestEventInfo(AppUpdateService.this, "指读", "下载完成,点击安装。", updatePendingIntent);
				updateNotificationManager.notify(0, updateNotification);
		...
		try {
			...
			while ((readsize = is.read(buffer)) > 0) {
				...
				if ((downloadCount == 0) || (int) (totalSize * 100 / updateTotalSize) - 10 > downloadCount) {
					...
					updateNotification.setLatestEventInfo(AppUpdateService.this, "正在下载",
